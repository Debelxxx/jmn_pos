    ...
    <div class="row-fluid">
            ...
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                     <li><a href="index.php"><i class="icon-dashboard icon-2x"></i> Dashboard </a></li> 
                        ...
                        <li class="active"><a href="inventory.php"><i class="icon-list-alt icon-2x"></i> Inventory</a></li>
        ...
        <div class="span10">
            <div class="contentheader">
                <i class="icon-table"></i> Inventory Management
            </div>
            <ul class="breadcrumb">
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#stock_in">Stock Entry</a></li>
                <li><a data-toggle="tab" href="#stock_out">Stock Adjustment</a></li>
            </ul>
            <div class="tab-content">
                ...
                <div id="products" class="tab-pane fade in active">
                    ...
                    <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a rel="facebox" title="Click to edit the product" href="editproduct.php?id=<?php echo $row['product_code']; ?>">
                                    <button class="btn btn-warning"><i class="icon-edit"></i> </button>
                                </a>
                                <a href="#" id="<?php echo $row['product_code']; ?>" class="delbutton" title="Click to Delete the product">
                ...
                <!-- Stock Entry Tab -->
                <div id="stock_in" class="tab-pane fade">
                    <?php include('stockin.php'); ?>
                </div>
                <!-- Stock Adjustment Tab -->
                <div id="stock_out" class="tab-pane fade">
                    <!-- Content for the Stock Adjustment tab goes here -->
                </div>
            </div><!---tab content-->
